    ...
    <div class="card card-body mt-2">
      <form  action="save_contact.php" method="post">
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end my-2">
          <input class="btn btn-primary" id="botonSubmit" name="save_contact" type="submit" value="enviar Datos">
        </div>
      </form>
    </div>
  </div>
      ...
      <tbody>
        ...
        while ($contacto_data = mysqli_fetch_array($resultado_consulta)) { ?>
          <tr>
            ...
            <td class="row justify-content-around pe-0 me-0">
              <a class='col-md-5 btn btn-info btn-sm' href="editar_contacto.php?id=<?=$contacto_data['tabla01_ID']?>">EDITAR</a>
              <a class='col-md-5 btn btn-danger btn-sm ' href="eliminar_contacto.php?id=<?=$contacto_data['tabla01_ID']?>">ELIMINAR</a>
            </td>
          </tr>
